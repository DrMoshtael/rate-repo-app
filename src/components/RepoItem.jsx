    ...
    <View testID="repoItem" style={styles.container}>
      <View style={styles.topContainer}>
        ...
        <View style={styles.detailsContainer}>
          ...
          <Text testID="repoItemDesc" color="textSecondary">
            {details.description}
          </Text>
